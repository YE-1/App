            ...
            public void onClick(View v) {
                ...
                if(editTextNum1.getText().toString().equals("")||editTextNum2.getText().toString().equals("")){
                    ...
                    switch (v.getId()) {
                        case R.id.btnAdd:
                            result = num1 + num2;
                            textViewResult.setText("덧셈 계산결과:" + result.toString());
                            break;

                        case R.id.btnSubtract:
                            result = num1 - num2;
                            textViewResult.setText("뺄셈 계산결과:" + result.toString());
                            break;

                        case R.id.btnMultiply:
                            result = num1 * num2;
                            textViewResult.setText("곱셈 계산결과:" + result.toString());
                            break;

                        case R.id.btnDivide:
                            result = num1 / num2;
                            textViewResult.setText("나눗셈 계산결과:" + result.toString());
                            break;
                    }
                }
            }
