package com.example.practice2_2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                adapter.notifyDataSetChanged(); // 이 메소드가 존재 하지 않으면 갱신이 안됨.
            }
        });

        // 요구사항 중 2. '선택된' 리스트 아이템을 수정
        // 1. '무엇'을 선택했는지를 판단 할 수가 있어야 함
        // 2. '선택된 위치'의 내용을 수정함
        ...
        // editBtn을 눌렀을 대 수정할 수 있도록 코드가 이 곳에 구현
